    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-8 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  required
                  className="block w-full px-3 py-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 sm:text-sm"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  required
                  className="block w-full px-3 py-3 pr-10 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 sm:text-sm"
      ...
      <div className="mt-8 text-center">
        <p className="text-xs text-gray-500">
          © 2025 CAS Billing System. All rights reserved.
        </p>
      </div>
    </div>
  );
